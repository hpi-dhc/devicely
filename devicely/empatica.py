...
class EmpaticaReader:
    """Parses, anonymizes and writes data generated by Empatica E4
    ...
    def __init__(self, path):
        ...
        if not _file_empty_or_not_existing(self.filelist['tags']):
    ...
    def _read_signal(self, signal_name):
        if _file_empty_or_not_existing(self.filelist[signal_name]):
    ...
    def _read_acc(self):
        if _file_empty_or_not_existing(self.filelist['acc']):
    ...
    def _read_ibi(self):
        if _file_empty_or_not_existing(self.filelist['ibi']):
    ...
    def timeshift(self, shift='random'):
        """
        Anonymizes the data by shifting all time related columns as well as the starting_times dict.
