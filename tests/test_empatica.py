...
class EmpaticaTestCase(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.expected_IBI_head = pd.DataFrame(
            ...
            index=pd.to_datetime(['2019-03-01 15:15:01.000000145',
                                  '2019-03-01 15:15:01.000000146',
                                  '2019-03-01 15:15:01.000000151',
                                  '2019-03-01 15:15:01.000000152',
                                  '2019-03-01 15:15:01.000000153'])
            )
